...
import { MapPin, Mail, Phone, Clock, Instagram, Linkedin, Youtube, MessageCircle, Send, Building2, User as UserIcon, Facebook } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#E0E0E0]">
                        India (Originally from Dubai, UAE)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@onehub.in" className="text-sm text-[#d7bf69] hover:underline cursor-pointer">
                        info@onehub.in
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.onehub.in" target="_blank" rel="noopener noreferrer" className="text-sm text-[#d7bf69] hover:underline cursor-pointer">
                        www.onehub.in
                      </a>
                    </div>
                  </div>
              ...
              >
                ...
                <button className="w-full border-2 border-[#d7bf69] text-[#d7bf69] px-6 py-3 rounded-lg hover:bg-[#d7bf69] hover:text-black transition-all flex items-center justify-center gap-2 cursor-pointer">
            ...
            <div className="flex items-center justify-center gap-6 mb-12">
              {[
                ...
                <a
                  key={i}
                  href={social.href}
                  className="w-16 h-16 rounded-full border-2 border-[#d7bf69]/50 flex items-center justify-center hover:border-[#d7bf69] hover:bg-[#d7bf69]/10 transition-all hover-lift group cursor-pointer"
                  aria-label={social.label}
                >
                  <social.icon className="w-7 h-7 text-[#d7bf69] group-hover:scale-110 transition-transform" />
                </a>
              ))}
            </div>
          </motion.div>
