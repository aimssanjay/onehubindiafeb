...
export function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#d7bf69] hover-lift">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1758691737644-ef8be18256c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGZvdW5kZXIlMjBwb3J0cmFpdHxlbnwxfHx8fDE3NjUyNzAyNjN8MA&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="OneHub Founder"
      ...
      {/* Team Section */}
      <section className="py-20 bg-black" id="team-section">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            className="text-center mb-16"
          >
            <h2>Meet the <span className="text-[#d7bf69]">Team</span></h2>
            <p className="text-xl text-[#E0E0E0] mt-4">
              The passionate experts behind OneHub's success
            </p>
          </motion.div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: 'Sarah Al-Mazrouei', role: 'Founder & CEO', description: 'Visionary leader with 10+ years in marketing' },
              { name: 'James Patterson', role: 'Head of Campaigns', description: 'Strategy expert with 200+ successful campaigns' },
              { name: 'Layla Hassan', role: 'Creator Relations', description: 'Community builder managing 5K+ creators' },
              { name: 'Marcus Chen', role: 'Data Analytics', description: 'Insights specialist driving performance' }
            ].map((member, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <div className="relative mb-6">
                  <div className="w-48 h-48 mx-auto rounded-full overflow-hidden border-2 border-[#d7bf69]/50 group-hover:border-[#d7bf69] transition-all hover-lift bg-gradient-to-br from-[#1a1a1a] to-black">
                    <div className="w-full h-full flex items-center justify-center">
                      <Users className="w-16 h-16 text-[#d7bf69] opacity-40" />
                    </div>
                  </div>
                  <div className="absolute -z-10 inset-0 bg-[#d7bf69] blur-[40px] opacity-0 group-hover:opacity-30 transition-opacity" />
                </div>
                <h4 className="mb-1">{member.name}</h4>
                <p className="text-[#d7bf69] mb-2">{member.role}</p>
                <p className="text-sm text-[#E0E0E0]">{member.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
