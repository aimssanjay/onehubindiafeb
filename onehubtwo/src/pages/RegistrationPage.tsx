...
export function RegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.mediaKitFile || formData.insightsFile || formData.demographicsFile || formData.licenseFile) {
  ...
  const handleFileChange = (
    ...
    field: "mediaKitFile" | "insightsFile" | "demographicsFile" | "licenseFile",
  ) => {
